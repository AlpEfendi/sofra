const CACHE='sofra-v2';
const FILES=['./','./index.html','./style.css','./data.js','./app.js','./manifest.webmanifest','./icon.svg','./icon-192.png','./icon-512.png',...['chicken','meat','fish','beans','vegetable','eggs'].map(x=>'./art/'+x+'.svg')];
