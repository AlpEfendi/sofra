const CACHE='sofra-v7';
const FILES=['./','./index.html','./style.css?v=7','./data.js?v=7','./app.js?v=7','./weight.js?v=7','./manifest.webmanifest','./icon.svg','./icon-192.png','./icon-512.png',...['chicken','meat','fish','beans','vegetable','eggs'].map(x=>'./art/'+x+'.svg')];
