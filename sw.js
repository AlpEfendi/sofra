const CACHE='sofra-v8';
const FILES=['./','./index.html','./style.css?v=8','./nutrition.js?v=8','./data.js?v=8','./app.js?v=8','./weight.js?v=8','./manifest.webmanifest','./icon.svg','./icon-192.png','./icon-512.png',...['chicken','meat','fish','beans','vegetable','eggs'].map(x=>'./art/'+x+'.svg')];
