const CACHE='sofra-v5';
const FILES=['./','./index.html','./style.css?v=5','./data.js?v=5','./app.js?v=5','./manifest.webmanifest','./icon.svg','./icon-192.png','./icon-512.png',...['chicken','meat','fish','beans','vegetable','eggs'].map(x=>'./art/'+x+'.svg')];
